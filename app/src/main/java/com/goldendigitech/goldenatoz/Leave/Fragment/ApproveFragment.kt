...
class ApproveFragment : Fragment() {
    ...
    lateinit var rv_approve: RecyclerView
    lateinit var yes_btn: Button
    lateinit var rl_alert: RelativeLayout
    val leaveStatus: String = "approve"

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
      val view: View = LayoutInflater.from(container?.context).inflate(R.layout.fragment_approve, container, false)
        ...
        rv_approve = view.findViewById(R.id.rv_approve)
