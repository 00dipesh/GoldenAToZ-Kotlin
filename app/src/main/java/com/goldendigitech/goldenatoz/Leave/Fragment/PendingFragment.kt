...
class PendingFragment : Fragment() {
    ...
    lateinit var rv_pending: RecyclerView
    ...
    override fun onCreateView(
        ...
        val view: View = LayoutInflater.from(container?.context).inflate(R.layout.fragment_pending, container, false)
